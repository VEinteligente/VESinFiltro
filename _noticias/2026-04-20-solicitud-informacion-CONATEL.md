---
layout: post
title: "VE sin Filtro exige a CONATEL levantar bloqueos en internet y responder solicitud de información"
...
---
VE sin Filtro exige a CONATEL levantar bloqueos en internet y responder solicitud de información
...
**Exigencia de respuesta y levantamiento de bloqueos**

De acuerdo con VE sin Filtro, en Venezuela se han acumulado durante más de una década bloqueos administrativos, discrecionales y sin transparencia, que han afectado a medios de comunicación, plataformas digitales, herramientas de comunicación y servicios diseñados para evadir la censura. En Venezuela siguen bloqueados 206 sitios web, 65 de ellos de medios de comunicación. 

Entre los servicios afectados se encuentran sitios web de noticias nacionales e internacionales, plataformas como X, Reddit, SoundCloud, Signal y Zello, así como herramientas de elusión de censura como VPN y la red Tor . También se documentan bloqueos a sitios de organizaciones de derechos humanos e iniciativas políticas, además de la persistencia de bloqueos residuales, incluso cuando las órdenes originales han sido levantadas o los dominios afectados han dejado de existir.

Frente a este escenario, VE sin Filtro sostiene que la solución no pasa por revisiones caso por caso, sino por una medida general que restituya el acceso: La vía más sencilla y eficaz es ordenar el cese inmediato de todos los bloqueos.

La mayoría de estas restricciones fueron impuestas por vía administrativa, sin control judicial ni transparencia, por lo que pueden ser levantadas de la misma manera. Solo en casos excepcionales -cuando exista una orden judicial, proporcional y necesaria- deberían mantenerse restricciones.

---
layout: post
title: "Censored Network: Restrictions on #InternetVE"
small: "Digital censorship and state control over information and communication in Venezuela intensified during 2025, continuing the patterns observed in 2024, especially around electoral processes."
excerpt: "Currently, 61 news websites are blocked, censoring virtually the entire ecosystem of independent media in the country, including the most important outlets, along with some international media. This has been devastating for freedom of expression and information and has compromised the sustainability of media outlets by reducing traffic to their websites.
This censorship against news sites is implemented through the blocking of 90 individual domains, since, in many cases, websites have used alternative domains to evade blocks. Although most of these blocks began in previous years, we have documented new blocks so far in 2025."
permalink: /noticias/2025-censorship-report/
date:   2026-01-17 09:20:00 -0400
categories: report
---
...
In the period from the July 2024 presidential elections until a few weeks after the inauguration in January 2025, Venezuela experienced the greatest concentration of serious human rights violations in the digital environment, as documented in our report [Control Networks: Digital Censorship and Repression in Venezuela’s Presidential Elections](http://vesinfiltro.org/elecciones-2024/).
...
The block combined DNS filtering, IP blocking, and TCP/IP traffic restrictions, preventing access to the platform without VPNs.
Telegram had also been blocked post-election in 2024, when mobile apps were unaffected but connections to telegram.org and web.telegram.org were disabled.
...
<table class="blocklist">
    <thead>
        <tr>
            ...
            <th colspan="7"><strong>ISP Blocking Mechanism</strong></th>
        </tr>
        <tr>
...
In February 2020, Punto de Corte's original domain ([puntodecorte.com](http://puntodecorte.com)) was blocked after it published a report titled “CANTV in ruins.” That block, which is still active, is a DNS block applied by Venezuela's main internet providers: CANTV, Movistar, Digitel, Inter, Supercable, and Movilnet.
